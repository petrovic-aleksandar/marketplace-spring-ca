...
public class PurchaseItemCommandHandler {
    ...
    public TransferDto handle(PurchaseItemCommand command) {

        // Validate command
        validateCommand(command);

        // fetch data and perform purchase in a single transaction
    ...
    private void validateCommand(PurchaseItemCommand command) {
